...
import com.example.groapp.MarketPlace.MarketPlaceActivity
import com.example.groapp.Model.EmployeeModel
...
class EmployeeDetailsActivity : AppCompatActivity() {
    ...
    private fun setValuesToViews() {
        ...
        tvCatName.text = intent.getStringExtra("empName")
    ...
    private fun openUpdateDialog(
        ...
        btnUpdateData.setOnClickListener {
            ...
            tvCatName.text = etEmpName.text.toString()
